...
export function IconSidebarKey({ size = 20, ...props }: IconProps) {
  return (
    <svg {...sidebarSvgProps} width={size} height={size} {...props}>
      <circle cx="8" cy="15" r="3.2" fill="currentColor" fillOpacity="0.12" />
      <path d="M10.3 12.7 21 2" />
      <path d="M16.5 6.5h3v3" />
      <path d="M13.5 9.5h3v3" />
